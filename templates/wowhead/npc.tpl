												...
												{ldelim}
													...
													<div class=q0>
														<small>
															{if isset($point.r)}
																{#Respawn#}:
																{if isset($point.r.d)} {$point.r.d}{#day#}{/if}
																{if isset($point.r.h)} {$point.r.h}{#hr#}{/if}
																{if isset($point.r.m)} {$point.r.m}{#min#}{/if}
																{if isset($point.r.s)} {$point.r.s}{#sec#}{/if}
																{if isset($point.mr)} - 
																	{if isset($point.mr.d)} {$point.mr.d}{#day#}{/if}
																	{if isset($point.mr.h)} {$point.mr.h}{#hr#}{/if}
																	{if isset($point.mr.m)} {$point.mr.m}{#min#}{/if}
																	{if isset($point.mr.s)} {$point.mr.s}{#sec#}{/if}
																{/if}
															{else}
																{#Waypoint#}
															{/if}
