...
switch($_SESSION['locale'])
{
	...
	case '8':
		mass_define(array(
			...
			// types
			'LOCALE_TYPE_BEAST'			=>	'Животное',
			'LOCALE_TYPE_DRAGONKIN'		=>	'Дракон',
			'LOCALE_TYPE_DEMON'			=>	'Демон',
			'LOCALE_TYPE_ELEMENTAL'		=>	'Элементаль',
			'LOCALE_TYPE_GIANT'			=>	'Великан',
			'LOCALE_TYPE_UNDEAD'		=>	'Нежить',
			'LOCALE_TYPE_HUMANOID'		=>	'Гуманоид',
			'LOCALE_TYPE_CRITTER'		=>	'Существо',
			'LOCALE_TYPE_MECHANICAL'	=>	'Механизм',
			'LOCALE_TYPE_UNCATEGORIZED' =>	'Разное',
			'LOCALE_TYPE_BOOK'			=>	'Книга',
			'LOCALE_TYPE_CONTAINER'		=>	'Контейнер',
			'LOCALE_TYPE_FOOTLOCKER'	=>	'Сундук',
			'LOCALE_TYPE_HERB'			=>	'Растение',
			'LOCALE_TYPE_MINERAL_VEIN'	=>	'Полезное ископаемое',
			'LOCALE_TYPE_QUEST'			=>	'Задание',
			// ranks
			'LOCALE_RANK_NORMAL'		=>	'Обычный',
			'LOCALE_RANK_ELITE'			=>	'Элитный',
			'LOCALE_RANK_RARE_ELITE'	=>	'Редкий элитный',
			'LOCALE_RANK_BOSS'			=>	'Босс',
			'LOCALE_RANK_RARE'			=>	'Редкий',
			// misc
	...
	default:
		mass_define(array(
			...
			// types
			'LOCALE_TYPE_BEAST'			=>	'Beast',
			'LOCALE_TYPE_DRAGONKIN'		=>	'Dragonkin',
			'LOCALE_TYPE_DEMON'			=>	'Demon',
			'LOCALE_TYPE_ELEMENTAL'		=>	'Elemental',
			'LOCALE_TYPE_GIANT'			=>	'Giant',
			'LOCALE_TYPE_UNDEAD'		=>	'Undead',
			'LOCALE_TYPE_HUMANOID'		=>	'Humanoid',
			'LOCALE_TYPE_CRITTER'		=>	'Critter',
			'LOCALE_TYPE_MECHANICAL'	=>	'Mechanical',
			'LOCALE_TYPE_UNCATEGORIZED' =>	'Uncategorized',
			'LOCALE_TYPE_BOOK'			=>	'Book',
			'LOCALE_TYPE_CONTAINER'		=>	'Container',
			'LOCALE_TYPE_FOOTLOCKER'	=>	'Footlocker',
			'LOCALE_TYPE_HERB'			=>	'Herb',
			'LOCALE_TYPE_MINERAL_VEIN'	=>	'Mineral Vein',
			'LOCALE_TYPE_QUEST'			=>	'Quest',
			// ranks
			'LOCALE_RANK_NORMAL'		=>	'Normal',
			'LOCALE_RANK_ELITE'			=>	'Elite',
			'LOCALE_RANK_RARE_ELITE'	=>	'Rare Elite',
			'LOCALE_RANK_BOSS'			=>	'Boss',
			'LOCALE_RANK_RARE'			=>	'Rare',
			// misc
			'LOCALE_SPEED'			=>	'Speed',
			'LOCALE_UNIQUE'			=>	'Unique',
